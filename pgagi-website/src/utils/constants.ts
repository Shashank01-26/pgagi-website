...
export const trendingList = [
	...
	{
		title: "AI News",
		description: "Llama 3 by Meta: Advanced AI Enhancements",
...
export const links = ["About Us", "Blog"];

export const resources = ["Terms & Conditions", "Privacy Policy", "Contact Us"];

export const socialList = [linkedin, instagram, youtube, x];
